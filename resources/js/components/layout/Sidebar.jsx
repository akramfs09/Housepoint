...
const Sidebar = () => {
    ...
    const menuItems = {
        ...
        seller: [
            ...
            { label: '🏠 Properti Saya', path: '/seller/properties', icon: '🏠' },
            { label: '➕ Tambah Properti', path: '/seller/properties/create', icon: '➕' },
        ...
        admin: [
            { label: '📊 Analisis Statistik', path: '/admin/dashboard', icon: '📊' },
            { label: '✅ Verifikasi Seller', path: '/admin/seller-verifications', icon: '✅' },
            { label: '✅ Log Aktivitas', path: '/admin/activity-logs', icon: '✅'},
            { label: '🏠 Moderasi Properti', path: '/admin/properties', icon: '🏠', disabled: true, soon: true },
        ...
        super_admin: [
            ...
            { label: '🔄 Ubah Role User', path: '/admin/users/roles', icon: '🔄', disabled: true, soon: true },
            { label: '🔄 Reset Apply Count', path: '/admin/seller-reset', icon: '🔄', disabled: true, soon: true },
        ],
    };
    ...
    return (
        <div className="bg-white rounded-2xl shadow-md border border-[#e5d8c0] overflow-hidden sticky top-24">
            ...
            <div className="border-t border-[#e5d8c0] px-5 py-3">
                <button onClick={handleLogout} className="w-full text-left text-[13px] text-red-500 hover:bg-red-50 rounded-lg px-4 py-2 transition flex items-center gap-3">
