const HeroSection = () => {
    return (
        <section className="relative h-[560px] overflow-hidden">
            ...
            <div className="relative z-10 max-w-[1180px] mx-auto px-6 pt-24">
                <div className="max-w-[520px] text-white">
                    <h2 className="text-[58px] leading-[1.15] font-bold">
                ...
                {/* TODO: Search berfungsi di Batch 3 */}
                <div className="mt-16 bg-white rounded-2xl shadow-2xl p-5 flex items-end gap-4 max-w-[980px]">
                    ...
                    <button className="h-[52px] px-8 rounded-xl bg-[#d49b37] text-white font-semibold text-[14px] shadow-lg hover:opacity-95 transition cursor-not-allowed"
