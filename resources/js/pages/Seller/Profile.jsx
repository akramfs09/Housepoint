...
const SellerProfile = () => {
    ...
    const [form, setForm] = useState({
        name: '', email: '', nama_lengkap: '', no_hp: '', alamat: '', jenis_kelamin: '',
    });
    ...
    const loadProfile = async () => {
        try {
            ...
            setForm({
                ...
                alamat: d.alamat || '', jenis_kelamin: d.jenis_kelamin || '',
            });
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* Kolom Kanan: Banner Promosi (Seller) */}
                <div className="lg:col-span-1">
                    <div className="bg-cover bg-center rounded-2xl overflow-hidden relative h-64"
                         style={{ backgroundImage: "url('https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600')" }}>
                        <div className="absolute inset-0 bg-black/40 p-6 flex flex-col justify-center">
                            <h3 className="text-white text-xl font-bold mb-2">Kelola Properti Anda</h3>
                            <p className="text-white/80 text-sm mb-4">Tambah properti, pantau performa, dan kelola listing dengan mudah.</p>
                            <a href="/seller/properties" className="bg-[#C5A065] text-white px-4 py-2 rounded-lg text-sm self-start">
                                Ke Properti Saya
                            </a>
                        </div>
                    </div>
